...
function Home() {
  return (
    <section id="home" className="home-section">
      <img src="/images/test project (1).png" alt="Zelion" className="home-logo tilt-on-hover" />
    </section>
  );
}
...
function Offers() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_1zkmftz', 'template_1axiexy', form.current, 'kPYQtDL4oIUEE5TvA')
      .then(
        (result) => {
  ...
  return (
    <section id="offers" className="offers-section">
      ...
      <p>Stay updated with our latest deals and cricket gear discounts!</p>
      ...
      {success && <p className="success-msg">Thanks for subscribing!</p>}
